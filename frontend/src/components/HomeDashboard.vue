<template>
  <section class="select-none text-center relative">
    ...
    <div class="absolute top-4 right-4">
      <button @click="logout" class="px-4 py-2 rounded-xl bg-red-600 text-white text-sm hover:bg-red-700 transition">
        Sair
      </button>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <!-- Dashboard Geral -->
      <RouterLink v-if="canSeeDashboard('geral')" to="/dashboards/geral"
      ...
      <!-- Financeiro -->
      <RouterLink v-if="canSeeDashboard('fin')" to="/dashboards/fin"
      ...
      <RouterLink v-if="canSeeDashboard('pedidos-fin')" to="/dashboards/pedidos-fin"
      ...
      <!-- Aguardando PCP -->
      <RouterLink v-if="canSeeDashboard('aguardando-pcp')" to="/dashboards/aguardando-pcp"
      ...
      <!-- Faturamento -->
      <RouterLink v-if="canSeeDashboard('faturamento')" to="/dashboards/faturamento"
      ...
      <!-- Romaneios -->
      <RouterLink v-if="canSeeDashboard('romaneios')" to="/dashboards/romaneios"
